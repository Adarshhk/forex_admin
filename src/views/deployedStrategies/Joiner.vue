        ...
        <div class=" w-full lg:w-[80dvw] ">
            <div class="flex items-center justify-between p-4 border-b border-white/15">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center justify-between ">
                        <div class="flex items-center gap-4">
                            <h1 class="font-bold text-lg">Strategy Joiners</h1>
                        </div>
                    </div>
                </div>
            ...
            <div class="table-container  min-h-[50vh]">
                <table class="w-full whitespace-nowrap overflow-x-auto">
                    ...
                    <tbody>
                        <tr v-if="strategyJoiners.length" v-for="(item, i) in strategyJoiners"
...
const { strategyJoiners } = storeToRefs(joinerStore);
...
watchEffect(async () => {
    if (props.strategyId && props.isOpen) {
        await joinerStore.getJoinersByStrategyId(props.strategyId);
    }
})
