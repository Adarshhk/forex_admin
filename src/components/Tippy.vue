...
const className = computed(() => {
  return `p-1 bg-[#20807d] dark:bg-[#20807d] mt-2 text-sm ${props.class}`
})
...
.tooltip-top {
  .tooltip-arrow {
    top: 100%;
    border-color: #20807d transparent transparent transparent;
  }
}
...
.tooltip-bottom {
  .tooltip-arrow {
    bottom: 100%;
    border-color: transparent transparent #20807d transparent;
  }
}
...
.tooltip-left {
  .tooltip-arrow {
    left: 100%;
    border-color: transparent transparent transparent #20807d;
  }
}
...
.tooltip-right {
  .tooltip-arrow {
    right: 100%;
    border-color: transparent #20807d transparent transparent;
  }
}
