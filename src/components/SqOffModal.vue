           ...
           <div class="w-[140px]">
              <LottieAnimation animationPath="/src/assets/animation/trash.json" />
					...
					<div class="flex flex-col items-center justify-center text-center p-4">
						<p class="text-lg sm:text-lg font-bold text-white/85 mt-2">Are you sure you want to square off?</p>
						<p class="text-xs sm:text-sm text-white/85 mt-2">This process can't be undone after this.</p>
					</div>
            ...
            <button @click="confirmModal" class="min-w-[93px] w-full text-sm px-6 py-2 rounded-md bg-custom-blue">Square Off</button>
					</div>
